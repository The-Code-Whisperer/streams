...
import reducers from './reducers'; // react uses reducers and actions, that's what it's all about in order to make components function, rather than a bunch of procedural stuff which is hard to reuse and is easy to bug out. Kinda like procedural vs OO. It's all centrally wired here, baby.
